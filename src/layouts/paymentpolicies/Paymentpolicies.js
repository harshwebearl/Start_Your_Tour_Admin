...
const Paymentpolicies = () => {
  ...
  const Call = async (ele) => {
    ...
    setFormData({
      term_and_condition_content: data.data[1].term_and_condition_content,
      term_and_condition_type: data.data[1].term_and_condition_type,
      id: data.data[1]._id,
    });
            ...
            <div className="w-full p-2 sm:p-4 md:p-6">
              <div className="w-full mb-3">
                ...
                <div className="w-full bg-[aliceblue] rounded-lg p-3 sm:p-4 md:p-6">
                  {/* Header */}
                  <h3 className="text-center mb-4 text-base sm:text-lg md:text-xl lg:text-2xl font-medium break-words px-2">
                  ...
                  <div className="w-full min-h-[300px] sm:min-h-[400px]">
                    <div
                      className="w-full border border-gray-200 rounded-lg overflow-x-hidden"
                ...
                <div className="flex justify-center text-center  w-full mt-6">
                  <MDButton
                    ...
                    type="submit"
                    className="w-full max-w-[200px] min-w-[120px] py-2.5 sm:py-3 text-sm sm:text-base"
                  >
                    Save
                  </MDButton>
                  {renderSuccessSB}
