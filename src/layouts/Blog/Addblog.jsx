...
const Addblog = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        if (!formData.blog_title || !formData.blog_category || !formData.blog_title_photo || !formData.blog_content) {
            openErrorSB();
            return;
        }
        try {
            ...
            formDataToSend.append("blogger_syt_id", _id);
                    ...
                    >
                        ...
                        <MDBox display="flex" alignItems="center">
                            ...
                            <MDInput
                                ...
                                mb={2}
                                style={{ marginLeft: "20px" ,marginBottom: "20px", width:"200px" }}
                            />
                        </MDBox>
                        <MDBox mb={2}>
                            <MDInput
