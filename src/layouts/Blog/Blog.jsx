        ...
        >
          ...
          <Link to="/Addblogger" style={{ textDecoration: "none" }}>
            <MDButton
              ...
              color="dark"
              sx={{
                padding: { xs: "6px", sm: "6px 16px" }, // Smaller padding on xs for icon-only
                fontSize: { xs: "12px", sm: "14px" },
                minWidth: { xs: "40px", sm: "120px" }, // Smaller width on xs
                height: { xs: "40px", sm: "auto" }, // Fixed height on xs for icon
                display: "flex",
                alignItems: "center",
                justifyContent: "center",
                gap: { xs: 0, sm: "8px" }, // No gap on xs, gap on sm
                "& .MuiIcon-root": {
